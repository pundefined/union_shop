...
void main() {
  group('Responsive utilities', () {
    group('Breakpoints', () {
      test('mobile breakpoint is 820', () {
        expect(Breakpoints.mobile, 820.0);
      });
    });

    group('Responsive.getScreenSize', () {
      test('returns mobile for width < 820', () {
        expect(Responsive.getScreenSize(0), ScreenSize.mobile);
        expect(Responsive.getScreenSize(300), ScreenSize.mobile);
        expect(Responsive.getScreenSize(600), ScreenSize.mobile);
        expect(Responsive.getScreenSize(819), ScreenSize.mobile);
      });

      test('returns desktop for width >= 820', () {
        expect(Responsive.getScreenSize(820), ScreenSize.desktop);
    ...
    group('Responsive.isMobile', () {
      test('returns true for width < 820', () {
        expect(Responsive.isMobile(0), true);
        expect(Responsive.isMobile(600), true);
        expect(Responsive.isMobile(819), true);
      });

      test('returns false for width >= 820', () {
        expect(Responsive.isMobile(820), false);
    ...
    group('Responsive.isDesktop', () {
      test('returns true for width >= 820', () {
        expect(Responsive.isDesktop(820), true);
        expect(Responsive.isDesktop(1200), true);
      });

      test('returns false for width < 820', () {
        expect(Responsive.isDesktop(819), false);
        expect(Responsive.isDesktop(600), false);
        expect(Responsive.isDesktop(0), false);
      });
    });

    group('Responsive.getGridColumnCount', () {
      test('returns 2 for mobile (< 820)', () {
      ...
      test('returns 4 for desktop (>= 820)', () {
    ...
    group('Responsive.getProductGridColumnCount', () {
      test('returns 2 for mobile (< 820)', () {
        ...
        expect(Responsive.getProductGridColumnCount(600), 2);
        expect(Responsive.getProductGridColumnCount(819), 2);
      });

      test('returns 3 for desktop (>= 820)', () {
        expect(Responsive.getProductGridColumnCount(820), 3);
        expect(Responsive.getProductGridColumnCount(900), 3);
        expect(Responsive.getProductGridColumnCount(1920), 3);
      });
    });
  });
}
